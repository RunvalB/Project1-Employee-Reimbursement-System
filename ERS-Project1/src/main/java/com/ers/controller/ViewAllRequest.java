...
public class ViewAllRequest extends HttpServlet {
	private static final Logger LOGGER = Logger.getLogger(ViewAllRequest.class);
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!allrequest.isEmpty()) {
			out.println("<table><tr><th>Request type</th> <th>Amount</th>  <th>Employee Name</th> <th> Email</th> <th>MobileNo</th> <th>Department</th> <th>Salary</th><th> Submitted On</th> <th> Approved </th><th>Pending/Resolved</th> </tr>");
			for (Request request2: allrequest) {
				...
				//With use of URL-Rewriting update status of requests using reqid
